...
const stats = [
  { value: '2.4배', label: '관리받은 학생의 평균 성적 향상률', sub: '비관리 학생 대비' },
  { value: '83%', label: '학원 이탈 방지 효과', sub: '정기 관리 피드백 제공 시' },
  { value: '3개월', label: '관리 효과가 수치로 나타나는 기간', sub: '주 2회 이상 피드백 기준' },
]
    ...
    <section id="essential" className="bg-white section-wrap">
      <div className="content-col">
        ...
        <div className="grid sm:grid-cols-3 gap-4 mb-16">
          {stats.map(s => (
            <div key={s.value} className="rounded-2xl p-5 border border-forest-100 bg-forest-50">
              <div className="text-3xl font-black mb-1" style={{color:'#0d6e4b'}}>{s.value}</div>
        ...
        <div className="mb-12">
          ...
          <div className="space-y-4">
            {theories.map(t => (
              <div key={t.person} className="rounded-2xl border border-slate-100 bg-slate-50 p-6 hover:border-forest-200 transition-colors">
