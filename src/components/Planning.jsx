    ...
    <section id="planning" className="section-wrap" style={{background:'linear-gradient(160deg, #020f08 0%, #0a1f17 60%, #0d2b1e 100%)'}}>
      <div className="content-col">
        ...
        <h2 className="display-lg text-white mb-6">
          관리 시스템을<br />
          <span style={{color:'#34d399'}}>오늘 설계하세요.</span>
        </h2>
        ...
        {submitted ? (
          <div className="bg-white/10 rounded-2xl p-8 text-center border border-white/10">
            <div className="w-16 h-16 rounded-full flex items-center justify-center mx-auto mb-4" style={{background:'rgba(13,110,75,0.3)'}}>
          ...
          <form onSubmit={handleSubmit} className="bg-white rounded-2xl p-7 sm:p-8 shadow-2xl">
            ...
            <div className="grid sm:grid-cols-2 gap-4 mb-4">
              <div>
                ...
                <input
                  ...
                  className="w-full border border-slate-200 rounded-xl px-4 py-3 text-sm focus:outline-none transition"
                />
              </div>
              <div>
                <label className="block text-sm font-medium text-slate-700 mb-1.5">
            ...
            <div className="mb-4">
              ...
              <div className="relative">
                <select
                  ...
                  className="w-full border border-slate-200 rounded-xl px-4 py-3 text-sm appearance-none focus:outline-none transition bg-white"
                >
            ...
            <div className="mb-6">
              ...
              <textarea
                ...
                className="w-full border border-slate-200 rounded-xl px-4 py-3 text-sm focus:outline-none transition resize-none"
              />
            </div>

            <button
              type="submit"
              className="w-full text-white font-bold py-4 rounded-xl flex items-center justify-center gap-2 text-base transition-colors"
